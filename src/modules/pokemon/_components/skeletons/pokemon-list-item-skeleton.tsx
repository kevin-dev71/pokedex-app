const PokemonListItemSkeleton = ({ name }: { name: string }) => {
  return (
    <article className="flex flex-col gap-3 rounded-xl bg-white p-4">
      <div role="status" className="max-w-sm animate-pulse rounded p-4 shadow-xl md:p-6">
        ...
        <span className="text-center text-grayscale-dark">{name}</span>
...
export default PokemonListItemSkeleton
